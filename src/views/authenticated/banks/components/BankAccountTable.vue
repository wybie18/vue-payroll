...
const columnVisibility = useStorage<VisibilityState>('bank-account-table-column-visibility', {})
  ...
  <div :class="cn('max-sm:has-[div[role=\'toolbar\']]:mb-16', 'flex flex-1 flex-col gap-4')">
    <div class="flex items-center justify-between gap-2">
      <div class="relative w-37.5 lg:w-62.5">
        ...
        <Input v-model="localSearch" placeholder="Filter by account number..." class="h-8 pl-8" />
      </div>
